...
function bmi() {
  ...
  let bmifixed = parseFloat(bmi.toFixed(1));
  bmifixedtype = typeof bmifixed;
  if (bmifixed < 18.5) {
    document.getElementById("result").innerHTML =
      "BMI : " + bmi.toFixed(1) + " (Underweight)";
  }
  if (bmifixed >= 18.5 && bmi.toFixed(1) <= 25) {
    document.getElementById("result").innerHTML =
      "BMI : " + bmi.toFixed(1) + " (Normal)";
  }
  if (bmifixed > 25) {
    document.getElementById("result").innerHTML =
      "BMI : " + bmi.toFixed(1) + " (Overweight)";
  }
}
